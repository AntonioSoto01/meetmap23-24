function iniciarMap() {
  ...
  marker1.addListener("mouseover", function () {
    infoWindow1.open(map, marker1); // Mostrar la pestaña de información cuando se hace hover
  });

  marker1.addListener("mouseout", function () {
    infoWindow1.close(); // Ocultar la pestaña de información cuando se quita el cursor
  });
