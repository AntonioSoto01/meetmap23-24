...
?>
    ...
    <!-- Contenido de tu página -->
        <section class="container-fluid p-5 section-contacto">
            ...
            <div class="col-lg-6 order-lg-1">
                <img src="./images/daniel.jpeg" alt="Imagen Circular de Daniel" class="img-fluid rounded-circle img-contacto">
            </div>
            <div class="col-lg-6 order-lg-2">
                ...
                <p>Profesional proactivo con mentalidad emprendedora, enérgico y comprometido con el logro de metas. 
                        ...
                        hasta la implementación exitosa. Habilidad demostrada para liderar equipos, inspirar motivación y alcanzar resultados. 
                        Apasionado por la innovación, se destaca por su adaptabilidad y capacidad para resolver desafíos de manera creativa. 
    ...
    <!-- Sección con imagen a la derecha y fondo oscuro -->
        <section class="bg-light text-dark p-5 section-contacto">
                <div class="row">
                    <div class="col-lg-6">
                    <h2>Antonio Soto Cid</h2>
                    <p>Dedicada profesional con una pasión inquebrantable por la creatividad y un compromiso innato hacia el trabajo. 
                        Poseo una ética laboral sólida y una mentalidad centrada en la productividad y la excelencia. Mi enfoque se fundamenta 
                        en la búsqueda constante de soluciones innovadoras para desafíos laborales, combinando habilidades creativas con una 
                        determinación incansable. Valoro la colaboración y el aprendizaje continuo, aprovechando cada oportunidad para crecer 
                        y mejorar. Mi trayectoria refleja una dedicación constante hacia el perfeccionamiento profesional, con resultados 
                    ...
                    <div class="col-lg-6">
                    <img src="./images/gear.png" alt="Imagen Circular de Antonio" class="img-contacto rounded-circle float-right mr-5">
                    </div>
                </div>
            </div>
        </section>
